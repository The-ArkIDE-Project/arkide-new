...
const isUploadAvailable = async () => {
    let res = null;
    try {
        res = await fetch('https://arkideapi.arc360hub.com/api/v1/projects/canuploadprojects').then(res => res.json());
    } catch {
            ...
            >
                <div className={classNames(styles.shareContent)}>
                    {isEdit ? <FormattedMessage
                            ...
                            description="Text for uploading edits for projects on ArkIDE"
